...
const Hero = (props) => (
  <Section row>
    <LeftSection>
      ...
      <SectionSubText><CiCircleAlert size={"100px"} color='#667AD1'/><p>🚀 Super excited to share that I'm currently doing my internship at Maon GmbH! 🌏💼 Can’t wait to come back with tons of experience and unforgettable memories! ✨</p>
      </SectionSubText>
      </SectionText>
      <Button>
      <IoIosDocument />
